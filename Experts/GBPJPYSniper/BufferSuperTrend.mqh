...
class SuperTrendBuffer: public CDoubleBuffer {
    public:
        SuperTrendBuffer(void);
        ~SuperTrendBuffer(void);
...
//| Constructor                                                      |
//+------------------------------------------------------------------+
SuperTrendBuffer::SuperTrendBuffer(void) {
}
...
//+------------------------------------------------------------------+
bool SuperTrendBuffer::Refresh(void) {
    if ((int)m_period < 100) {
        double low_array[];
        double high_array[];
        double close_array[];
...
//| Refreshing of the data buffer                                    |
//+------------------------------------------------------------------+
bool SuperTrendBuffer::RefreshCurrent(void) {
    return Refresh();
}
